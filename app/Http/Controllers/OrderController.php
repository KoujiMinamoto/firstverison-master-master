...
{   
    ...
    public function saveTemOrder(Request $request) {
    ...
    public function getTemOrder(Request $request) {
        $order_user = $request->input('userName');
        $temOrder = DB::table('oneprint_order')->where('user_name',$user_name)->get();


    }

    public function deleteTemOrder(Request $request) {
        $order_user = $request->input('userName');
        DB::table('oneprint_order')->where('user_name',$user_name)->detele();
